...
import { add_points_any_a_benchmark } from '../submission/add_points_any_a_benchmark';
...
export const AllBenchmarks: React.FC = () => {
  ...
  return (
    <div>
      ...
      />
      <Benchmark
        name={'Add Points benchmark (any "a" value)'}
        disabled={disabledBenchmark}
        baseAffinePoints={baseAffineBigIntPoints}
        scalars={bigIntScalars}
        expectedResult={expectedResult}
        msmFunc={add_points_any_a_benchmark}
        postResult={postResult}
        bold={true}
      />
      <Benchmark
        name={'Add Points benchmark (a = -1)'}
        disabled={disabledBenchmark}
        baseAffinePoints={baseAffineBigIntPoints}
        scalars={bigIntScalars}
        expectedResult={expectedResult}
