...
/*fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {*/
    ...
    /*let num_scalars = arrayLength(&scalars);*/
    ...
    /*for (var i = 0u; i < NUM_SUBTASKS - 1u; i ++) {*/
        /*let offset = i * num_scalars;*/
        /*result[id + offset] = extract_word_from_bytes_le(scalar_bytes, i);*/
    /*}*/

    /*result[gidx + (NUM_SUBTASKS - 1u) * num_scalars] = scalar_bytes[0] >> (((NUM_SUBTASKS * CHUNK_SIZE - 256u) + 16u) - CHUNK_SIZE);*/
/*}*/
