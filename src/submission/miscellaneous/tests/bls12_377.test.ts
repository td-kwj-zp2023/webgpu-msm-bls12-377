...
describe("BLS12-377", () => {
  const x = BigInt(
    "256948617686061222151099205917657017678095364246733267446961262336245752294716969877488967765059276401456368208320",
  );
  const y = BigInt(
    "227105170010858909588581432763679191613848062092956907254157646977554095359559069986365111542605613311147866154268",
  );
  const z = BigInt(
    "200530079991103180348766713932858124680528544393104247922429137530783589900802654704895259718337700840462356557585",
  );
  ...
  it("createAffinePoint()", () => {
    ...
    expect(p.z().toBig().toString()).toEqual("1");
  });
