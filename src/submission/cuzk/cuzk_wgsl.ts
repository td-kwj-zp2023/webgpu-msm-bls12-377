...
import curve_parameters from '../wgsl/curve/ec_parameters.template.wgsl'
import field_functions from '../wgsl/field/field.template.wgsl'
import montgomery_product_functions from '../wgsl/montgomery/mont_pro_optimised.template.wgsl'
